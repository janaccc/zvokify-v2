...
export default function Songs() {
    // DODANO: pridobimo funkcije iz Contexta
    const { setCurrentSong, setSongs } = usePlayer();
    ...
    const { data: songs, isLoading, error, isError } = useQuery({
        queryFn: getallSongs,
        queryKey: ["allSongs"],
        // DODANO: shrani seznam pesmi v Context ob uspehu
        onSuccess: (data) => {
    ...
    if (isLoading)
        ...
        return (<div className="min-h-[90vh] bg-background my-15 p-4 lg:ml-80 rounded-lg mx-4">
                ...
                {songs?.map((song: Song, index) => {
                    return (
                        <div
                            ...
                            // DODANO: ob kliku nastavi pesem v MusicPlayer
                        ...
                        >
                            ...
                            {/* PLAY GUMB ob hover, na sredini slike */}
